...
![Структурная схема предоставления доли bandwidth аккаунту 2 на средства аккаунта 1](./images/Fig1.jpg)  
...
![Структурная схема выделения ресурсов bandwidth по принципу разделяемого bandwidth](./images/Fig2.jpg)  
...
Решение о том, в какой пропорции общая полоса пропускания (bandwidth) распределяется между зонами гарантированной и приоритетной полос, принимается блок-продюсерами.
...
![Структурная схема алгоритма обработки запроса на выделение ресурсов bandwidth](./images/Fig3.jpg)  
