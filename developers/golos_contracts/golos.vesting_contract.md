...
`max_interest` — максимально допустимый процент вознаграждения за делегирование средств (доля вознаграждения за курирование).
...
`params` — вектор-массив из нескольких параметров. Каждый параметр имеет привязку к одному из символов вестинга и представляет собой структуру [вида vesting_param](https://cyberway.gitbook.io/ru/v/devel-ru/developers/golos_contracts/golos.vesting_contract#parametry-ustanavlivaemye-v-smart-kontrakte-golos-vesting) .
...
### Операция-действие stopwithdraw
...
### Операции-действия timeoutrdel, timeoutconv и timeout
