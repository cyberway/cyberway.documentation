...
#### 1.1 Стадии создания и развертывания приложения на CyberWay  
...
#### 1.3 Требования к квалификации персонала, устанавливающего приложение на блокчейне CyberWay  
...
**1.4.1** Определить правила сообщества:   
...
**1.4.2** Построить структурные схемы алгоритмов функционирования приложения сообщества по принятым правилам.  
 В логику отдельного контракта будет реализован отдельный алгоритм (отдельная группа правил).  

**1.4.3** Подготовить узел блокчейна.  
